...
import 'package:flutter_fiver_ecom_admin_app/firebase/auth_service.dart';
import 'package:flutter_fiver_ecom_admin_app/helper/keyboard.dart';
...
class _SignFormState extends State<SignForm> {
  ...
  void _firebaseSignIn(String currEmail, String currEpassword) async{
      await _auth.signInWithEmailAndPassword(email: currEmail, password: currEpassword).then((uid) =>{
